...
# Last revision: loading data from csv
...
#
# PRIME MOVERS: Items for which detailed projections are made. Move on their own in response to deliberate firm actions (e.g. revenues)
# SECONDARY MOVERS: Items pegged as a fixed percentage of a prime mover or summary line (e.g. fuel costs)
# SUMMARY LINES: Items which sum prime and secondary movers (e.g. EBITDA)
...
with open('income-statement-so.csv', 'r') as df:
